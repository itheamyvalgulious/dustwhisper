...
PAGE_STRIPE_FIELD_PATHS: tuple[tuple[int, tuple[str, ...]], ...] = (
    ...
    (12, ("cell", "reaction_chain_generation")),
    (13, ("gas", "ambient_temperature")),
    (14, ("gas", "flow_velocity")),
    (15, ("gas", "reaction_chain_generation")),
    (16, ("gas", "gas_concentration")),
    (17, ("runtime", "island_ids")),
    (18, ("runtime", "island_velocity")),
    (19, ("runtime", "island_subcell_offset")),
    (20, ("runtime", "entity_placeholder_entity_id")),
)
