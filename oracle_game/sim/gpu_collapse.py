...
from oracle_game.sim.gpu_collapse_dirty import (
    COMPACT_LOCAL_SIZE,
    clear_collapse_structure_dirty_tile_queue_on_gpu,  # noqa: F401  # facade re-export, grafting/monkeypatch contract
...
_SHADER_SUBS: dict[str, Any] = {
    ...
    "COMPACT_LOCAL_SIZE": COMPACT_LOCAL_SIZE,
...
class GPUCollapsePipeline(GPUPipelineBase):
    ...
    def _ensure_programs(self, ctx: Any | None) -> None:
        if not ctx or self.programs:
            return
        self.programs["classify_cells"] = build_compute_shader(
            ctx, "collapse/classify_cells.comp", _SHADER_SUBS
        )
        self.programs["propagate"] = build_compute_shader(
            ctx, "collapse/propagate.comp", _SHADER_SUBS
        )
        self.programs["component_label_init"] = build_compute_shader(
            ctx, "collapse/component_label_init.comp", _SHADER_SUBS
        )
        self.programs["seed_structural_region"] = build_compute_shader(
            ctx, "collapse/seed_structural_region.comp", _SHADER_SUBS
        )
        self.programs["copy_mask_texture"] = build_compute_shader(
            ctx, "collapse/copy_mask_texture.comp", _SHADER_SUBS
        )
        self.programs["copy_mask_texture_connected_tiles"] = build_compute_shader(
            ctx, "collapse/copy_mask_texture_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["filter_formal_connected_eligibility"] = build_compute_shader(
            ctx, "collapse/filter_formal_connected_eligibility.comp", _SHADER_SUBS
        )
        self.programs["filter_formal_connected_eligibility_connected_tiles"] = build_compute_shader(
            ctx, "collapse/filter_formal_connected_eligibility_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_connected_frontier_rect"] = build_compute_shader(
            ctx, "collapse/seed_formal_connected_frontier_rect.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_connected_tile_frontier"] = build_compute_shader(
            ctx, "collapse/seed_formal_connected_tile_frontier.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_connected_tile_frontier_from_dirty_queue"] = (
            build_compute_shader(
                ctx,
                "collapse/seed_formal_connected_tile_frontier_from_dirty_queue.comp",
                _SHADER_SUBS,
            )
        )
        self.programs["expand_formal_connected_tiles"] = build_compute_shader(
            ctx, "collapse/expand_formal_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["classify_formal_connected_tiles"] = build_compute_shader(
            ctx, "collapse/classify_formal_connected_tiles.comp", _SHADER_SUBS
        )
        ...
        self.programs["classify_formal_connected_tiles_bridge_publish_incremental"] = (
            build_compute_shader(
                ctx,
                "collapse/classify_formal_connected_tiles.comp",
                {
        ...
        self.programs["classify_formal_connected_tiles_bridge_publish_incremental_packed"] = (
            build_compute_shader(
                ctx,
                "collapse/classify_formal_connected_tiles.comp",
                {
        ...
        self.programs["classify_formal_connected_tiles_bridge_publish_incremental_axis_u8"] = (
            build_compute_shader(
                ctx,
        ...
        self.programs[
            "classify_formal_connected_tiles_bridge_publish_incremental_packed_axis_u8"
        ] = build_compute_shader(
            ctx,
            "collapse/classify_formal_connected_tiles_support_axis_u8.comp",
            {
        ...
        self.programs["clear_formal_connected_tile_worklist"] = build_compute_shader(
            ctx, "collapse/clear_formal_connected_tile_worklist.comp", _SHADER_SUBS
        )
        self.programs["compact_formal_connected_tile_mask"] = build_compute_shader(
            ctx, "collapse/compact_formal_connected_tile_mask.comp", _SHADER_SUBS
        )
        self.programs["clear_formal_connected_cell_buffer"] = build_compute_shader(
            ctx, "collapse/clear_formal_connected_cell_buffer.comp", _SHADER_SUBS
        )
        self.programs["clear_formal_connected_tile_mask_buffer"] = build_compute_shader(
            ctx, "collapse/clear_formal_connected_tile_mask_buffer.comp", _SHADER_SUBS
        )
        self.programs["clear_formal_connected_tile_masks_by_list"] = build_compute_shader(
            ctx, "collapse/clear_formal_connected_tile_masks_by_list.comp", _SHADER_SUBS
        )
        self.programs["clear_formal_connected_cell_buffer_connected_tiles"] = build_compute_shader(
            ctx, "collapse/clear_formal_connected_cell_buffer_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["clear_formal_connected_cell_frontier_tiles"] = build_compute_shader(
            ctx, "collapse/clear_formal_connected_cell_frontier_tiles.comp", _SHADER_SUBS
        )
        self.programs["clear_formal_connected_cell_frontier_tile_flags_by_list"] = (
            build_compute_shader(
                ctx,
                "collapse/clear_formal_connected_cell_frontier_tile_flags_by_list.comp",
                _SHADER_SUBS,
            )
        )
        self.programs["reset_formal_connected_cell_frontier_tiles"] = build_compute_shader(
            ctx, "collapse/reset_formal_connected_cell_frontier_tiles.comp", _SHADER_SUBS
        )
        self.programs["accumulate_formal_connected_cell_frontier_tiles"] = build_compute_shader(
            ctx, "collapse/accumulate_formal_connected_cell_frontier_tiles.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_connected_tile_support_frontier"] = build_compute_shader(
            ctx, "collapse/seed_formal_connected_tile_support_frontier.comp", _SHADER_SUBS
        )
        self.programs["expand_formal_connected_tile_support_frontier"] = build_compute_shader(
            ctx, "collapse/expand_formal_connected_tile_support_frontier.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_connected_cell_frontier"] = build_compute_shader(
            ctx, "collapse/seed_formal_connected_cell_frontier.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_connected_cell_frontier_from_dirty_queue"] = (
            build_compute_shader(
                ctx,
                "collapse/seed_formal_connected_cell_frontier_from_dirty_queue.comp",
                _SHADER_SUBS,
            )
        )
        self.programs["expand_formal_connected_cells_by_tile"] = build_compute_shader(
            ctx, "collapse/expand_formal_connected_cells_by_tile.comp", _SHADER_SUBS
        )
        self.programs["copy_formal_connected_buffer_to_texture"] = build_compute_shader(
            ctx, "collapse/copy_formal_connected_buffer_to_texture.comp", _SHADER_SUBS
        )
        self.programs["seed_structural_frontier_region"] = build_compute_shader(
            ctx, "collapse/seed_structural_frontier_region.comp", _SHADER_SUBS
        )
        self.programs["publish_internal_boundary_frontier"] = build_compute_shader(
            ctx, "collapse/publish_internal_boundary_frontier.comp", _SHADER_SUBS
        )
        self.programs["detect_connected_internal_boundary_flags"] = build_compute_shader(
            ctx, "collapse/detect_connected_internal_boundary_flags.comp", _SHADER_SUBS
        )
        self.programs["enqueue_connected_internal_boundary_deferred_regions"] = (
            build_compute_shader(
                ctx,
                "collapse/enqueue_connected_internal_boundary_deferred_regions.comp",
                _SHADER_SUBS,
            )
        )
        self.programs["seed_internal_boundary_region"] = build_compute_shader(
            ctx, "collapse/seed_internal_boundary_region.comp", _SHADER_SUBS
        )
        self.programs["exclude_boundary_connected_mask"] = build_compute_shader(
            ctx, "collapse/exclude_boundary_connected_mask.comp", _SHADER_SUBS
        )
        self.programs["build_formal_connected_axis_masks"] = build_compute_shader(
            ctx, "collapse/build_formal_connected_axis_masks.comp", _SHADER_SUBS
        )
        ...
        self.programs["propagate_formal_connected_component_labels"] = build_compute_shader(
            ctx, "collapse/propagate_formal_connected_component_labels.comp", _SHADER_SUBS
        )
        self.programs["component_label_propagate"] = build_compute_shader(
            ctx, "collapse/component_label_propagate.comp", _SHADER_SUBS
        )
        self.programs["seed_formal_component_label_frontier"] = build_compute_shader(
            ctx, "collapse/seed_formal_component_label_frontier.comp", _SHADER_SUBS
        )
        ...
        self.programs["expand_formal_component_label_frontier"] = build_compute_shader(
            ctx, "collapse/expand_formal_component_label_frontier.comp", _SHADER_SUBS
        )
        self.programs["copy_formal_component_label_buffer_to_texture"] = build_compute_shader(
            ctx, "collapse/copy_formal_component_label_buffer_to_texture.comp", _SHADER_SUBS
        )
        self.programs["collect_component_labels"] = build_compute_shader(
            ctx, "collapse/collect_component_labels.comp", _SHADER_SUBS
        )
        self.programs["clear_component_label_flags_connected_tiles"] = build_compute_shader(
            ctx, "collapse/clear_component_label_flags_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["collect_component_labels_connected_tiles"] = build_compute_shader(
            ctx, "collapse/collect_component_labels_connected_tiles.comp", _SHADER_SUBS
        )
        ...
        self.programs["validate_incremental_component_labels_union_materialize"] = (
            build_compute_shader(
                ctx,
        ...
        self.programs["validate_incremental_component_labels_union_materialize_generation"] = (
            build_compute_shader(
                ctx,
                "collapse/validate_incremental_component_labels_union_materialize.comp",
                {**_SHADER_SUBS, "INVALID_COMPONENT_GENERATION_VALIDITY": 1},
        ...
        self.programs["validate_incremental_component_labels_union_materialize_packed"] = (
            build_compute_shader(
                ctx,
                "collapse/validate_incremental_component_labels_union_materialize.comp",
                {**_SHADER_SUBS, "PACKED_INCREMENTAL_SNAPSHOT": 1},
        ...
        self.programs["materialize_incremental_components_bridge_metadata_filter"] = (
            build_compute_shader(
                ctx,
                "collapse/materialize_incremental_components_bridge.comp",
                {
        ...
        self.programs["materialize_incremental_components_bridge_metadata_filter_generation"] = (
            build_compute_shader(
                ctx,
                "collapse/materialize_incremental_components_bridge.comp",
                {
        ...
        self.programs["build_component_dispatch_args"] = build_compute_shader(
            ctx, "collapse/build_component_dispatch_args.comp", _SHADER_SUBS
        )
        self.programs["index_compact_component_labels"] = build_compute_shader(
            ctx, "collapse/index_compact_component_labels.comp", _SHADER_SUBS
        )
        self.programs["summarize_compact_components"] = build_compute_shader(
            ctx, "collapse/summarize_compact_components.comp", _SHADER_SUBS
        )
        self.programs["summarize_compact_components_connected_tiles"] = build_compute_shader(
            ctx, "collapse/summarize_compact_components_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["summarize_components"] = build_compute_shader(
            ctx, "collapse/summarize_components.comp", _SHADER_SUBS
        )
        self.programs["resolve_outcomes"] = build_compute_shader(
            ctx, "collapse/resolve_outcomes.comp", _SHADER_SUBS
        )
        self.programs["resolve_outcomes_from_supported"] = build_compute_shader(
            ctx, "collapse/resolve_outcomes_from_supported.comp", _SHADER_SUBS
        )
        self.programs["resolve_outcomes_from_supported_connected_tiles"] = build_compute_shader(
            ctx, "collapse/resolve_outcomes_from_supported_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["resolve_outcomes_from_supported_connected_tiles_publish"] = (
            build_compute_shader(
                ctx,
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge_publish"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_immune"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_publish_immune"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge_immune"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge_publish_immune"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_outcomes"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_publish_outcomes"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge_outcomes"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge_outcomes_packed"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        self.programs["resolve_outcomes_from_supported_connected_tiles_bridge_publish_outcomes"] = (
            build_compute_shader(
                ctx,
                "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
                {
        ...
        for program_suffix, substitutions in support_u8_outcome_variants:
            self.programs[f"resolve_outcomes_from_supported_connected_tiles{program_suffix}_u8"] = (
                build_compute_shader(
                    ctx,
                    "collapse/resolve_outcomes_from_supported_connected_tiles.comp",
        ...
        self.programs["materialize_components"] = build_compute_shader(
            ctx, "collapse/materialize_components.comp", _SHADER_SUBS
        )
        self.programs["materialize_components_aux"] = build_compute_shader(
            ctx, "collapse/materialize_components_aux.comp", _SHADER_SUBS
        )
        self.programs["materialize_compact_components"] = build_compute_shader(
            ctx, "collapse/materialize_compact_components.comp", _SHADER_SUBS
        )
        self.programs["materialize_compact_components_aux"] = build_compute_shader(
            ctx, "collapse/materialize_compact_components_aux.comp", _SHADER_SUBS
        )
        self.programs["materialize_compact_components_connected_tiles"] = build_compute_shader(
            ctx, "collapse/materialize_compact_components_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["materialize_compact_components_aux_connected_tiles"] = build_compute_shader(
            ctx, "collapse/materialize_compact_components_aux_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["materialize_dense_components"] = build_compute_shader(
            ctx, "collapse/materialize_dense_components.comp", _SHADER_SUBS
        )
        self.programs["materialize_dense_components_aux"] = build_compute_shader(
            ctx, "collapse/materialize_dense_components_aux.comp", _SHADER_SUBS
        )
        self.programs["init_dense_component_metadata"] = build_compute_shader(
            ctx, "collapse/init_dense_component_metadata.comp", _SHADER_SUBS
        )
        self.programs["summarize_dense_components"] = build_compute_shader(
            ctx, "collapse/summarize_dense_components.comp", _SHADER_SUBS
        )
        self.programs["publish_dense_component_island_runtime"] = build_compute_shader(
            ctx, "collapse/publish_dense_component_island_runtime.comp", _SHADER_SUBS
        )
        self.programs["publish_compact_component_island_runtime"] = build_compute_shader(
            ctx, "collapse/publish_compact_component_island_runtime.comp", _SHADER_SUBS
        )
        self.programs["load_bridge_region_cell"] = build_compute_shader(
            ctx, "collapse/load_bridge_region_cell.comp", _SHADER_SUBS
        )
        self.programs["load_bridge_connected_tile_cell"] = build_compute_shader(
            ctx, "collapse/load_bridge_connected_tile_cell.comp", _SHADER_SUBS
        )
        self.programs["load_bridge_region_cell_aux"] = build_compute_shader(
            ctx, "collapse/load_bridge_region_cell_aux.comp", _SHADER_SUBS
        )
        self.programs["load_bridge_connected_tile_cell_aux"] = build_compute_shader(
            ctx, "collapse/load_bridge_connected_tile_cell_aux.comp", _SHADER_SUBS
        )
        self.programs["load_bridge_connected_tile_pending"] = build_compute_shader(
            ctx, "collapse/load_bridge_connected_tile_pending.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_cell"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_cell.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_cell_connected_tiles"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_cell_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_cell_connected_tiles_incremental"] = (
            build_compute_shader(
                ctx,
        ...
        self.programs["load_bridge_region_pending"] = build_compute_shader(
            ctx, "collapse/load_bridge_region_pending.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_pending"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_pending.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_pending_connected_tiles"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_pending_connected_tiles.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_mask"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_mask.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_mask_connected_tiles"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_mask_connected_tiles.comp", _SHADER_SUBS
        )
        ...
        self.programs["publish_bridge_supported_unsupported_masks_connected_tiles_u8"] = (
            build_compute_shader(
                ctx,
                "collapse/publish_bridge_supported_unsupported_masks_connected_tiles.comp",
        ...
        self.programs["publish_bridge_region_labels"] = build_compute_shader(
            ctx, "collapse/publish_bridge_region_labels.comp", _SHADER_SUBS
        )
        self.programs["publish_bridge_region_labels_connected_tiles"] = build_compute_shader(
