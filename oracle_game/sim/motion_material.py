...
def _material_scalar(
    solver, world: "WorldEngine", material_id: int, field: str, fallback: np.ndarray
) -> float:
...
def _material_powder_generation_id(solver, world: "WorldEngine", material_id: int) -> int:
    ...
    return solver._material_int(
        world, material_id, "powder_generation_id", world.material_powder_generation_id
    )
...
def _material_max_dda_step(solver, world: "WorldEngine", material_id: int) -> int:
    return max(
        0, solver._material_int(world, material_id, "max_dda_step", world.material_max_dda_step)
    )


def _material_powder_solver_kind(solver, world: "WorldEngine", material_id: int) -> int:
    return solver._material_int(
        world, material_id, "powder_solver_kind_id", world.material_powder_solver_kind
    )
