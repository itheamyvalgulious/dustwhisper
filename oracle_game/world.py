...
class WorldEngine:
    ...
    _serialize_bridge_readback_request_stages = staticmethod(
        _serialize_bridge_readback_request_stages
    )
    ...
    _decode_bridge_uploaded_page_stripe_section = staticmethod(
        _decode_bridge_uploaded_page_stripe_section
    )
    ...
    _sync_loaded_page_stripe_cpu_mirror = _sync_loaded_page_stripe_cpu_mirror
    _queue_loaded_collapse_pending_regions_from_payload = (
        _queue_loaded_collapse_pending_regions_from_payload
    )
